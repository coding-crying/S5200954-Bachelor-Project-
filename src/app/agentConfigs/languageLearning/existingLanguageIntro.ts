...
[
  ...
  },
  {
    ...
    "examples": [
      "You've made a great start today by reconnecting with your Spanish. Remember, you're not starting from zero - you already have a solid foundation to build upon. Would you like to continue practicing with our AI tutor Carlos? He can help you work on those present tense verbs in natural conversation and gradually build your confidence.",
      "Today we've assessed your French level and identified your strengths and areas for growth. You've retained more than you thought! Would you like to continue with our conversational AI tutor who can help you practice what we've discussed and gradually introduce new vocabulary at your level?"
    ],
    "transitions": [{
      "next_step": "transfer_to_ai_tutor",
      "condition": "If user wants to continue with conversational practice."
    }, {
      "next_step": "end_session",
      "condition": "If user wants to end the session."
    }]
  },
  {
    "id": "transfer_to_ai_tutor",
    "description": "Transfer the user to the AI tutor for conversational practice.",
    "instructions": [
      "Explain that you're connecting them with Carlos, the AI tutor, who will help them practice at their assessed level.",
      "Mention that Carlos will help them work on the specific areas identified during the assessment.",
      "Use the transferAgents tool to connect them to the aiTutor agent."
    ],
    "examples": [
      "Perfect! Let me connect you with Carlos, our AI language tutor. He's aware of your current level and will help you practice those verb conjugations we identified, while building your confidence through natural conversation.",
      "Excellent! I'm transferring you to Carlos now. He'll help you practice at your intermediate level and work on the specific areas we discussed during your assessment."
    ],
    "transitions": [{
      "next_step": "transferAgents",
      "condition": "Transfer to aiTutor agent."
    }]
  },
  {
    "id": "end_session",
    "description": "End the session with encouragement and resources.",
    "instructions": [
      "Thank the user for their time and effort.",
      "Summarize their strengths and next steps.",
      "Provide encouragement for independent practice."
    ],
    "examples": [
      "Thank you for this productive session! You have a solid foundation to build upon. Focus on those verb conjugations and listening practice we discussed. I'm confident you'll see great progress with consistent effort.",
      "It's been wonderful working with you today! Remember, you've retained more than you thought. Keep practicing with the resources we discussed, and you'll see your confidence grow quickly."
    ],
    "transitions": []
  }
]
