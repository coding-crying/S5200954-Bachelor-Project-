...
[
  ...
  },
  {
    ...
    "examples": [
      "Would you like to continue learning some Spanish now with our AI tutor Carlos? He can help you practice these phrases in conversation and introduce new vocabulary naturally. Or would you prefer to practice these phrases on your own first?",
      "You've made a great start with Japanese today! Would you like to continue with our conversational AI tutor who can help you practice these phrases in context and gradually introduce new vocabulary? Or would you prefer to practice on your own first?"
    ],
    "transitions": [{
      "next_step": "transfer_to_ai_tutor",
      "condition": "If user wants to continue learning with conversational practice."
    }, {
      "next_step": "7_session_conclusion",
      "condition": "If user wants to end the session or practice independently."
    }]
  },
  {
  ...
  },
  {
    ...
    "instructions": [
      "Explain that you're connecting them with Carlos, the AI tutor, who will help them practice in conversation.",
      "Mention that Carlos will help them use the phrases they just learned and gradually introduce new vocabulary.",
      "Use the transferAgents tool to connect them to the aiTutor agent."
    ],
    "examples": [
      "Perfect! Let me connect you with Carlos, our AI language tutor. He'll help you practice the phrases you just learned in natural conversation and gradually introduce new vocabulary as you're ready for it.",
      "Excellent choice! I'm transferring you to Carlos now. He's great at helping beginners practice their new phrases in context and building confidence through conversation."
    ],
    "transitions": [{
