    ...
    <div className="bg-gray-100 p-4 rounded-lg shadow-md mb-4">
      ...
      <div className="flex items-center mb-4">
        ...
        <span className="text-sm font-medium">
          {isProcessing ? 'Processing vocabulary...' : 'Vocabulary processing active'}
        </span>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="w-full p-2 bg-gray-50 border border-gray-200 rounded-md text-sm">
          GPT-4.1-mini (Individual Processing)
        </div>
      </div>
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-3 rounded">
        <p className="text-sm text-blue-700">
          <span className="font-semibold">Individual Processing:</span> Each message is processed immediately when received for real-time vocabulary analysis and CSV updates.
        </p>
      </div>
    </div>
  );
